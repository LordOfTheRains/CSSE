...
class DispatchTest(unittest.TestCase):
    ...
    def test_dispatch_invalid_correct(self):
        ...
        input_dict = {'op': 'correct', 'long': '95d41.6',
                      'altitude': '13d42.3',  'assumedLat': '-53d38.4',
                      'assumedLong': ' 74d35.3'}
        result = dispatcher.dispatch(input_dict)
        self.assertTrue("error" in result, result)
        
        input_dict = {'op': 'correct', 'lat': '16.0d32.3',
                      'long': '95d41.6', 'altitude': '13d42.3',
                      'assumedLat': '-53d38.4',
                      'assumedLong': '74d35.3'}
        result = dispatcher.dispatch(input_dict)
        self.assertTrue("error" in result, result)
        
        input_dict = {'op': 'correct', 'lat': '16d32.3',
                      'long': '95d1.6', 'altitude': '13d42.3',
                      'assumedLat': '-153d38.4',
                      'assumedLong': ' 74d35.3'}
        result = dispatcher.dispatch(input_dict)
        self.assertTrue("error" in result, result)
